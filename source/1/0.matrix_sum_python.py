...
x = [[1 for column in range(0, shape[1])] for row in range(0, shape[0])]
y = [[1 for column in range(0, shape[1])] for row in range(0, shape[0])]

# __2. Write the sequential program to find the value of $z$__
z = [[(x[row][column]**2 + y[row][column]**2) for column in range(0, shape[1])] for row in range(0, shape[0])]
